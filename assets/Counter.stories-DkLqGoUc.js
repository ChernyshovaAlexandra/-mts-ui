import{j as n}from"./jsx-runtime-Cf8x2fCZ.js";import{y as V,p as i}from"./styled-components.browser.esm-BU5pfHrT.js";import{v as B}from"./mixins-CTkzXf3m.js";import{q,F as N,E as A,N as E,Q as y,P as h}from"./index-CWlbk4Hf.js";/* empty css              */import"./index-yBjzXJbu.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";const I=V.span`
...
`,M={s:i`
  ...
  ${B};
`,a=({value:e,size:r="m",variant:s="red",max:x=99,pad:v=!1,className:f,style:g})=>{if(r==="notification")return n.jsx(I,{className:f,style:g,"aria-hidden":!0});const u=e===void 0?null:e>x?`${x}+`:v?String(e).padStart(2,"0"):String(e),O=!v&&e!==void 0&&e<=9;return n.jsx(Q,{$size:r,$variant:s,$circular:O,className:f,style:g,"aria-label":u?`${u} уведомлений`:void 0,children:u})};a.__docgenInfo={description:"",methods:[],displayName:"Counter",props:{value:{required:!1,tsType:{name:"number"},description:""},size:{required:!1,tsType:{name:"union",raw:'"notification" | "s" | "m" | "l"',elements:[{name:"literal",value:'"notification"'},{name:"literal",value:'"s"'},{name:"literal",value:'"m"'},{name:"literal",value:'"l"'}]},description:"",defaultValue:{value:'"m"',computed:!1}},variant:{required:!1,tsType:{name:"union",raw:'"red" | "dark" | "ghost"',elements:[{name:"literal",value:'"red"'},{name:"literal",value:'"dark"'},{name:"literal",value:'"ghost"'}]},description:"",defaultValue:{value:'"red"',computed:!1}},max:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"99",computed:!1}},pad:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""}}};const ee={title:"МТС/Counter",component:a,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...(R=(w=d.parameters)==null?void 0:w.docs)==null?void 0:R.source}}};var $,D,_;c.parameters={...c.parameters,docs:{...($=c.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "Варианты",
  parameters: {
    controls: {
      disable: true
...
}`,...(_=(D=c.parameters)==null?void 0:D.docs)==null?void 0:_.source}}};var L,T,P;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(P=(T=p.parameters)==null?void 0:T.docs)==null?void 0:P.source}}};const ne=["Default","Sizes","CircularVsPill","Variants","OnBackgrounds"];export{d as CircularVsPill,o as Default,p as OnBackgrounds,l as Sizes,c as Variants,ne as __namedExportsOrder,ee as default};
