import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{r as l}from"./index-Dx_1l3Sb.js";import{y as r}from"./styled-components.browser.esm-y4XIFzD1.js";import{S as s}from"./Switch-CRDX_VIh.js";import{C as A,G as y,E}from"./index-B66h-egn.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./Spinner-5z9YM4jE.js";import"./IconYoutube-CikJe2Kh.js";import"./createIcon-DXdYUD03.js";import"./IconAttention-OHJemvOI.js";import"./IconBookmark-CFJE0vQI.js";import"./IconOut-BVbMsUOi.js";import"./IconLeft-C3XBBr1z.js";import"./IconDate-BrvuUuHU.js";import"./IconTime-Bvy4Z0sQ.js";import"./IconLink-CnepHNOO.js";import"./IconChevronRight-jbCZTIeY.js";import"./IconCross-DrP_deE0.js";import"./IconMore-B_vxfzTm.js";import"./IconPicture-B6KsTlBs.js";import"./IconEdit--ReOD0mK.js";import"./mixins-ib8c4tLP.js";const ge={title:"МТС/Switch",component:s,tags:["autodocs"],parameters:{docs:{description:{component:`
...
`,B=r.span`
  ...
  font-size: 12px;
  color: ${y};
`,h={name:"Размеры",parameters:{controls:{disable:!0}},render:()=>{const[n,i]=l.useState({s:!0,m:!0,l:!0});return e.jsx(F,{children:["s","m","l"].map(t=>e.jsxs(V,{children:[e.jsx(s,{size:t,checked:n[t],onChange:a=>i(o=>({...o,[t]:a}))}),e.jsxs(B,{children:[t," — ",I[t]]})]},t))})}},I={s:"28×16",m:"42×24",l:"56×32"},K=r.div`
  display: grid;
...
}`,...(v=(T=h.parameters)==null?void 0:T.docs)==null?void 0:v.source}}};var L,$,G;g.parameters={...g.parameters,docs:{...(L=g.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: "Все состояния",
  parameters: {
    controls: {
      disable: true
...
}`,...(G=($=g.parameters)==null?void 0:$.docs)==null?void 0:G.source}}};var R,D,M;u.parameters={...u.parameters,docs:{...(R=u.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: "Loading (async)",
  parameters: {
    controls: {
      disable: true
...
}`,...(O=(H=x.parameters)==null?void 0:H.docs)==null?void 0:O.source}}};const ue=["Default","Sizes","AllStates","Loading","InSettings"];export{g as AllStates,m as Default,x as InSettings,u as Loading,h as Sizes,ue as __namedExportsOrder,ge as default};
