import{j as t}from"./jsx-runtime-Cf8x2fCZ.js";import{r as N}from"./index-G8LIXM5I.js";import{y as s,p as x}from"./styled-components.browser.esm-BU5pfHrT.js";import{v as A}from"./mixins-CTkzXf3m.js";import{s as v,v as H,L as O}from"./index-CWlbk4Hf.js";/* empty css              */import{a as U,I as Z}from"./IconBookmark-BesuOxsj.js";import{I as G}from"./IconHeart-CQgzpcxH.js";import{I as J}from"./IconDate-BrvuUuHU.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./createIcon-CRC-JE94.js";const K=e=>e===3?x`gap: 32px; padding: 0 16px;`:e===4?x`gap: 16px; padding: 0 8px;`:x`padding: 0 4px;`,Q=s.div`
  position: relative;
  width: 100%;
...
\`\`\`
        `}},backgrounds:{default:"light",values:[{name:"light",value:"#F2F3F7"},{name:"dark",value:"#1D2023"}]}},argTypes:{items:{description:"Массив вкладок. Каждая содержит `icon` (ReactNode) и `label` (строка). От 3 до 5 элементов.",control:"object"},activeIndex:{description:"Индекс активной вкладки (начиная с 0).",control:{type:"number",min:0,max:4}},onChange:{description:"Коллбек при смене вкладки. Получает индекс выбранной вкладки.",action:"tab changed"},divider:{description:"Горизонтальная линия-разделитель сверху компонента.",control:"boolean"},style:{control:!1},className:{control:!1}}},i=e=>t.jsx(e,{width:24,height:24,color:"currentColor"}),o=[{icon:i(U),label:"Главная"},{icon:i(q),label:"Каталог"},{icon:i(Z),label:"Избранное"},{icon:i(G),label:"Акции"},{icon:i(J),label:"Профиль"}],M=o.slice(0,4),L=o.slice(0,3),z=({children:e})=>t.jsxs("div",{style:{width:375,height:200,background:"#fff",borderRadius:16,overflow:"hidden",position:"relative",boxShadow:"0 4px 24px rgba(0,0,0,0.12)",display:"flex",flexDirection:"column",justifyContent:"flex-end"},children:[t.jsx("div",{style:{flex:1,padding:16,color:"#969FA8",fontSize:13,fontFamily:"sans-serif"},children:"Контент страницы"}),e]}),b=e=>{const[n,r]=N.useState(e.activeIndex??0);return t.jsx(z,{children:t.jsx(u,{...e,activeIndex:n,onChange:r})})},l={name:"5 вкладок",render:b,args:{items:o,activeIndex:0,divider:!0}},c={name:"4 вкладки",render:b,args:{items:M,activeIndex:0,divider:!0}},d={name:"3 вкладки",render:b,args:{items:L,activeIndex:0,divider:!0}},m={name:"Без разделителя",render:b,args:{items:o,activeIndex:0,divider:!1},parameters:{docs:{description:{story:"Разделитель отключается пропом `divider={false}` — например, если фон контента уже визуально отделяет TabBar."}}}},p={name:"Все варианты",parameters:{controls:{disable:!0},docs:{description:{story:"Три варианта по количеству вкладок. Отступы и зазоры подбираются автоматически."}}},render:()=>t.jsx("div",{style:{display:"flex",flexDirection:"column",gap:32,alignItems:"flex-start"},children:[{label:"3 вкладки",items:L},{label:"4 вкладки",items:M},{label:"5 вкладок",items:o}].map(({label:e,items:n})=>t.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[t.jsx("span",{style:{fontSize:11,color:"#969FA8",fontFamily:"sans-serif",textTransform:"uppercase",letterSpacing:"0.05em"},children:e}),t.jsx(z,{children:t.jsx(u,{items:n,activeIndex:0,divider:!0})})]},e))})};var h,y,T;l.parameters={...l.parameters,docs:{...(h=l.parameters)==null?void 0:h.docs,source:{originalSource:`{
  name: "5 вкладок",
...
}`,...(R=($=p.parameters)==null?void 0:$.docs)==null?void 0:R.source}}};const fe=["FiveTabs","FourTabs","ThreeTabs","NoDivider","AllVariants"];export{p as AllVariants,l as FiveTabs,c as FourTabs,m as NoDivider,d as ThreeTabs,fe as __namedExportsOrder,be as default};
