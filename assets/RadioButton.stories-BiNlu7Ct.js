import{j as f}from"./jsx-runtime-Cf8x2fCZ.js";import{r as R}from"./index-Dx_1l3Sb.js";import{R as h}from"./RadioButton-Ch8o_-Ou.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./styled-components.browser.esm-y4XIFzD1.js";import"./mixins-ib8c4tLP.js";import"./style-CYyl-vEM.js";/* empty css              */import"./index-B66h-egn.js";import"./style-CaScT4Df.js";const W={title:"МТС/FormItems/RadioButton",component:h,tags:["autodocs"],argTypes:{onChange:{action:"changed"}}},o=({checked:k,onChange:t,...S})=>{const[v,b]=R.useState(!!k);return f.jsx(h,{...S,checked:v,onChange:n=>{b(n.target.checked),t==null||t(n)}})},e=o.bind({});e.args={name:"radioGroup1",value:"option1",label:"Select me",checked:!0};const a=o.bind({});a.args={name:"radioGroup2",value:"option2",label:"Select me",errorMessage:"Error: Something went wrong",checked:!1};const r=o.bind({});r.args={name:"radioGroup3",value:"option3",label:"Select me",checked:!1,disabled:!0};var s,c,u;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`({
  checked,
  onChange,
  ...args
}) => {
