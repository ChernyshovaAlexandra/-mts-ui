import{j as f}from"./jsx-runtime-Cf8x2fCZ.js";import{r as S}from"./index-Dx_1l3Sb.js";import{C as k}from"./Checkbox-dYe7jkND.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./styled-components.browser.esm-y4XIFzD1.js";import"./mixins-ib8c4tLP.js";import"./index-B66h-egn.js";/* empty css              */import"./style-CaScT4Df.js";const y={title:"МТС/FormItems/Checkbox",component:k,tags:["autodocs"],argTypes:{onChange:{action:"changed"}}},t=({checked:p,onChange:s,...b})=>{const[C,x]=S.useState(!!p);return f.jsx(k,{...b,checked:C,onChange:c=>{x(c.target.checked),s==null||s(c)}})},e=t.bind({});e.args={name:"checkbox1",label:"Check me",errorMessage:"",checked:!0};const r=t.bind({});r.args={name:"checkbox2",label:"Check me",errorMessage:"Error: Something went wrong",checked:!1};const a=t.bind({});a.args={name:"checkbox3",label:"Check me",errorMessage:"",checked:!1,disabled:!0};var o,n,h;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`({
  checked,
  onChange,
  ...args
}) => {
