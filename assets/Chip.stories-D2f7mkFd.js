import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{r as d}from"./index-Dx_1l3Sb.js";import{p as c,y as j}from"./styled-components.browser.esm-y4XIFzD1.js";import{h as _,E as y,g as ee,x as te,e as se}from"./index-B66h-egn.js";import{v as ne}from"./mixins-ib8c4tLP.js";import{t as k}from"./style-CYyl-vEM.js";import{b as w,a as oe,I as re,c as ie}from"./IconCross-DrP_deE0.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";/* empty css              */import"./createIcon-DXdYUD03.js";const ae={medium:c`
    border-radius: 16px;
    padding: 12px 10px;
    gap: 4px;
    ${k["P4-Regular-Comp"]}
...
`,i=({size:t="medium",selected:s=!1,selectedVariant:n="filled",disabled:o=!1,icon:r,menu:S=!1,menuOpen:l=!1,onClose:b,onClick:Q,children:X,...Y})=>{const v=s&&n==="filled",Z=()=>!S&&b?e.jsx($,{type:"button",$onDark:v,onClick:p=>{p.stopPropagation(),b(p)},"aria-label":"Удалить",children:e.jsx(w,{size:16})}):S?s&&b?e.jsx($,{type:"button",$onDark:v,onClick:p=>{p.stopPropagation(),b(p)},"aria-label":"Сбросить",children:e.jsx(w,{size:16})}):e.jsx(z,{children:l?e.jsx(oe,{size:16}):e.jsx(re,{size:16})}):null;return e.jsxs(le,{type:"button",$size:t,$selected:s,$selectedVariant:n,$disabled:o,disabled:o,onClick:o?void 0:Q,"aria-pressed":s,...Y,children:[r&&e.jsx(z,{children:r}),X,Z()]})},a=({children:t,style:s,...n})=>e.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:8,...s},...n,children:t});i.__docgenInfo={description:"",methods:[],displayName:"Chip",props:{size:{required:!1,tsType:{name:"union",raw:'"medium" | "small"',elements:[{name:"literal",value:'"medium"'},{name:"literal",value:'"small"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},selected:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},selectedVariant:{required:!1,tsType:{name:"union",raw:'"filled" | "outline"',elements:[{name:"literal",value:'"filled"'},{name:"literal",value:'"outline"'}]},description:"",defaultValue:{value:'"filled"',computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},icon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Leading icon or graphic"},menu:{required:!1,tsType:{name:"boolean"},description:"Shows trailing chevron that flips when open; when selected shows × instead",defaultValue:{value:"false",computed:!1}},menuOpen:{required:!1,tsType:{name:"boolean"},description:"Controls chevron direction when menu=true",defaultValue:{value:"false",computed:!1}},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"(e: React.MouseEvent<HTMLButtonElement>) => void",signature:{arguments:[{type:{name:"ReactMouseEvent",raw:"React.MouseEvent<HTMLButtonElement>",elements:[{name:"HTMLButtonElement"}]},name:"e"}],return:{name:"void"}}},description:"× handler — for form chip (always shows ×) or menu chip when selected"},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}},composes:["Omit"]};a.__docgenInfo={description:"",methods:[],displayName:"ChipGroup",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}},composes:["HTMLAttributes"]};const ye={title:"МТС/Chip",component:i,tags:["autodocs"]},u=()=>{const t=["Молоко","Сыр","Кефир","Ряженка","Сметана"],[s,n]=d.useState("Ряженка");return e.jsx(a,{children:t.map(o=>e.jsx(i,{selected:s===o,onClick:()=>n(o===s?null:o),children:o},o))})},m=()=>{const t=["Минибон","Синнабон","Капкейк","Шоколад","Круассан"],[s,n]=d.useState(new Set(["Синнабон","Шоколад"])),o=r=>{n(S=>{const l=new Set(S);return l.has(r)?l.delete(r):l.add(r),l})};return e.jsx(a,{children:t.map(r=>e.jsx(i,{selected:s.has(r),onClick:()=>o(r),children:r},r))})},h=()=>{const[t,s]=d.useState("Музыка");return e.jsx(a,{children:["Музыка","Путешествия","Животные"].map(n=>e.jsx(i,{selected:t===n,icon:e.jsx(ie,{size:16}),onClick:()=>s(n),children:n},n))})},f=()=>{const[t,s]=d.useState(!1),[n,o]=d.useState(!1);return e.jsx(a,{children:e.jsx(i,{menu:!0,menuOpen:t,selected:n,onClick:()=>{n||s(r=>!r)},onClose:()=>{o(!1),s(!1)},children:"Chip"})})},C=()=>{const[t,s]=d.useState(["Option 1","Option 2"]);return e.jsx(a,{children:t.map(n=>e.jsx(i,{selected:!0,onClose:()=>s(o=>o.filter(r=>r!==n)),children:n},n))})},x=()=>e.jsxs(a,{children:[e.jsx(i,{size:"medium",children:"Medium 44"}),e.jsx(i,{size:"small",children:"Small 32"}),e.jsx(i,{size:"medium",selected:!0,children:"Medium Selected"}),e.jsx(i,{size:"small",selected:!0,children:"Small Selected"})]}),g=()=>e.jsxs(a,{children:[e.jsx(i,{children:"Default"}),e.jsx(i,{selected:!0,children:"Selected"}),e.jsx(i,{selected:!0,selectedVariant:"outline",children:"Selected Alt"}),e.jsx(i,{disabled:!0,children:"Disabled"})]});u.__docgenInfo={description:"",methods:[],displayName:"Default"};m.__docgenInfo={description:"",methods:[],displayName:"Multiselect"};h.__docgenInfo={description:"",methods:[],displayName:"WithIcon"};f.__docgenInfo={description:"",methods:[],displayName:"MenuChip"};C.__docgenInfo={description:"",methods:[],displayName:"FormChip"};x.__docgenInfo={description:"",methods:[],displayName:"Sizes"};g.__docgenInfo={description:"",methods:[],displayName:"States"};var I,M,R;u.parameters={...u.parameters,docs:{...(I=u.parameters)==null?void 0:I.docs,source:{originalSource:`() => {
...
}`,...(H=(V=f.parameters)==null?void 0:V.docs)==null?void 0:H.source}}};var L,B,P;C.parameters={...C.parameters,docs:{...(L=C.parameters)==null?void 0:L.docs,source:{originalSource:`() => {
...
}`,...(P=(B=C.parameters)==null?void 0:B.docs)==null?void 0:P.source}}};var W,A,F;x.parameters={...x.parameters,docs:{...(W=x.parameters)==null?void 0:W.docs,source:{originalSource:`() => <ChipGroup>
  ...
  </ChipGroup>`,...(F=(A=x.parameters)==null?void 0:A.docs)==null?void 0:F.source}}};var U,J,K;g.parameters={...g.parameters,docs:{...(U=g.parameters)==null?void 0:U.docs,source:{originalSource:`() => <ChipGroup>
    <Chip>Default</Chip>
    <Chip selected>Selected</Chip>
    <Chip selected selectedVariant="outline">Selected Alt</Chip>
    <Chip disabled>Disabled</Chip>
  </ChipGroup>`,...(K=(J=g.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const je=["Default","Multiselect","WithIcon","MenuChip","FormChip","Sizes","States"];export{u as Default,C as FormChip,f as MenuChip,m as Multiselect,x as Sizes,g as States,h as WithIcon,je as __namedExportsOrder,ye as default};
